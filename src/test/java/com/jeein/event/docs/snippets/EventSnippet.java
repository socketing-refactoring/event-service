...
public class EventSnippet {
    ...
    public static final QueryParametersSnippet SINGLE_EVENT_QUERY_PARAMETER =
        queryParameters(
            parameterWithName("excludeSeat").description("좌석 정보 조회 여부").optional()
        );
    ...
    public static final ResponseFieldsSnippet SINGLE_EVENT_DETAIL_WITHSEAT_RETRIEVAL_RESPONSE_FIELDS =
        CommonSnippet.successResponseFields().and(fieldWithPath("data").description("이벤트 목록"),
            fieldWithPath("data.id").description("이벤트 ID"),
            fieldWithPath("data.title").description("공연 제목"),
            fieldWithPath("data.description").description("공연 설명"),
    ...
    public static final ResponseFieldsSnippet SINGLE_EVENT_DETAIL_NOSEAT_RETRIEVAL_RESPONSE_FIELDS =
        CommonSnippet.successResponseFields().and(fieldWithPath("data").description("이벤트 목록"),
            fieldWithPath("data.id").description("이벤트 ID"),
            fieldWithPath("data.title").description("공연 제목"),
            fieldWithPath("data.description").description("공연 설명"),
    ...
    public static final ResponseFieldsSnippet SEAT_LIST_RETRIEVAL_RESPONSE =
        CommonSnippet.successResponseFields().and(
            fieldWithPath("data[].id").description("좌석 아이디"),
            fieldWithPath("data[].cx").description("좌석 x 좌표"),
            fieldWithPath("data[].cy").description("좌석 y 좌표"),
            fieldWithPath("data[].row").description("좌석 행 번호"),
            fieldWithPath("data[].number").description("좌석 번호"),
            fieldWithPath("data[].areaId").description("좌석이 속한 구역 아이디")
        );
}
